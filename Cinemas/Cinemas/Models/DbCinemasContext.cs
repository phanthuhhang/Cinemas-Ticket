...
public partial class DbCinemasContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=LAPTOP-9V5UDGM5\\SQLEXPRESS;Database=Cinemas;Integrated Security=true;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<KhachHang>(entity =>
        {
            ...
            entity.HasOne(d => d.IdaccountNavigation).WithMany(p => p.KhachHangs)
                .HasForeignKey(d => d.Idaccount)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_KhachHang_Accounts1");
        });
